...
const EnrolledCourseCard = async ({ enrollment }: EnrolledCourseCardProps) => {
  ...
  try {
    ...
    return (
      <div className="group hover:shadow-lg transition-all duration-300 overflow-hidden border rounded-xl bg-white dark:bg-gray-800 h-full">
        {/* Single Link wrapper for the entire card */}
        <Link href={`/courses/${courseId}`} className="block h-full">
          ...
          <div className="flex flex-col p-4 space-y-4">
            {/* Título - no longer wrapped in Link */}
            <div>
            ...
            {/* Botón de continuar - now as a styled div instead of Link */}
