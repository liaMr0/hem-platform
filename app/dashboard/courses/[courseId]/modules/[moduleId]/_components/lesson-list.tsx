...
export const LessonList = ({ items, onReorder, onEdit }:any) => {
  ...
  const onDragEnd = (result:any) => {
    ...
    const bulkUpdateData = updatedModules.map((module:any) => ({
      id: module.id,
      position: items.findIndex((item:any) => item.id === module.id),
    }));
